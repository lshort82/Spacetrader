...
public enum Item {
    ...
    ORE(3, "Ore", 2, 2, 3, 350, 20, 10, "War", Resources.MINERALRICH, Resources.MINERALPOOR, 350, 420),
    GAMES(4, "Games", 3, 1, 6, 250, -10, 5, "Bordom", Resources.ARTISTIC, null, 160, 270),
    FIREARMS(5,"Firearms",3, 1, 5, 1250, -75, 100, "WAR", Resources.WARLIKE, null, 600, 1100),
    MEDICINE(6, "Medicine", 4, 1, 6, 650, -20, 10, "PLAGUE", Resources.LOTSOFHERBS,	null, 400, 700),
    MACHINES(7, "Machines",4, 3, 5, 900, -30, 5, "LACKOFWORKERS", null, null, 600, 800),
    NARCOTICS(8, "Narcotics", 5, 0, 5, 3500, -125, 150, "BOREDOM", Resources.WEIRDMUSHROOMS, null, 2000, 3000),
    ROBOTS(9, "Robots", 6, 4, 7, 5000, -150, 100, "LACKOFWORKERS", null, null, 3500, 5000);


    private int index;
    private String name;
    private int minTechProd;
    private int minTechUse;
    private int maxTechProd;
    private int price;
    private int incPerTech;
    private int variance;
    private String event;
    private Resources cheap;
    private Resources expensive;
